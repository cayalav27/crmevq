...
class PerfilGestorController{
    ...
    public function Index(){
        ...
        require_once 'view/gestormarketing/layout/menu_prf.php';
        require_once 'view/gestormarketing/perfilusuario/perfilusuario.php';
    ...
    public function UpdSrcEmp(){
        $miperf = new perfilusuario();

        $miperf->TxtCodEmp = $_REQUEST['TxtCodEmp'];
        $miperf->TxtCodSrc = $_REQUEST['TxtCodSrc'];

        $this->model->UpdSrcEmp($miperf);
