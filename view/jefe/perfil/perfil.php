                ...
                <div class="card">
                    ...
                    <div class="body table-responsive">
                        <div class="col-sm-4 col-md-4" align="center">
                            ...
                            <form id="sign_in" action="perfiljefe&a=UpdFotEmp" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-8 col-md-8">
                            <table class="table" style="border-left: 1px solid #D0D3D4">
                                <tbody>
                                    ...
                                    <tr>
                                        <td width="25"></td>
                                        <form id="sign_in" action="perfiljefe&a=UpdEmlEmp" method="post" enctype="multipart/form-data">
                                            <input type="hidden" name="TxtCodEmp" value="<?php echo $user = $objses->get('CodEmp'); ?>" />
                                    ...
                                    <tr>
                                        <td width="25"></td>
                                        <form id="sign_in" action="perfiljefe&a=UpdPswEmp" method="post" enctype="multipart/form-data">
                                            <input type="hidden" name="TxtCodEmp" value="<?php echo $user = $objses->get('CodEmp'); ?>" />
