                            ...
                            <ol class="breadcrumb breadcrumb-col-red">
                                <li>
                                    <span data-toggle='tooltip' data-placement="bottom" title='Volver'>
                                        <a href="marketingjf"><i class="material-icons">markunread_mailbox</i> Marketing</a>
                                    </span>
                                </li>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <ul class="nav nav-tabs tab-col-teal" role="tablist">
                                    <li role="presentation" class="active">
                                        <a href="<?php echo urlencode('marketingjf&a=DetalleMkt&CodMrk=').$dtmkt->CodMrk; ?>">ATENCIONES</a>
                                    </li>
                                    <li role="presentation">
                                        <a href="<?php echo urlencode('equipomktjf&a=Index&CodMrk=').$dtmkt->CodMrk; ?>">EQUIPO</a>
                                    </li>
                                </ul>
