<?php
    ...
    foreach($this->model->ListSegCal($pdfvnt->CodVnt, $pdfvnt->CodEmp , $pdfvnt->CodPrf) as $r):
    ...
    $content .= '
            ...
            <table class="table" cellpadding="4">
                <tbody>
                    <tr>
                        <th width="125">Empleado del Negocio</th>
                        <td width="25">:</td>
                        <td>'.$r->NomApeEmp.'</td>
                    </tr>
                    <tr>
    ...
    $content .= '
                    <tr>
                        ...
                        <td width="25">:</td>';
                        $i = 1;
                        foreach($this->model->SegProdList($r->CodVnt) as $row):
    $content .= '
