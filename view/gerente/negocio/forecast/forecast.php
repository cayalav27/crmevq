                    ...
                    <div class="card">
                        <div class="header">
                            <ol class="breadcrumb breadcrumb-col-red">
                                <li><a href="javascript:void(0);"><i class="material-icons">public</i> Negocios</a></li>
                        ...
                        <div class="body table-responsive">
                            <table id="dtable" class="display compact" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    <?php $i = 1; ?>
                                    <?php foreach($this->model->ListFrcForm($iduser = $objses->get('CodEmp') , $iduser = $objses->get('CodPrf')) as $r): ?>
                                    <tr>
                                        <td><?php echo $i++ ?></td>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form id="sign_in" enctype="multipart/form-data">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <tr>                                            
                                                                    <th width="150"></th>
                                                                    <td width="25"></td>
                                                                    <td><?php echo $i++ ?>. <?php echo $row["NomProd"] ?></td>
                                                                </tr>
                                                                <?php endforeach; ?>
                                                            </tr>
                                                            <tr>
                                                ...
                                                <div class="modal-footer">
                                                    <center>
                                                        <button type="button" class="btn bg-grey btn-xs waves-effect">
                                                            <i class="material-icons">print</i>
                                                            <span>IMPRIMIR</span>
                                                        </button>  
