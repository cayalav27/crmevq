                    ...
                    <div class="card">
                        ...
                        <div class="body table-responsive">
                            ...
                            <table id="dtable" class="display compact" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    <?php $i = 1; ?>
                                    <?php foreach($this->model->RentList2($Seg->TxtCodEmp, $Seg->TxtFIni, $Seg->TxtFFin) as $r): ?>
                                    <tr>
                                        <td><?php echo $i++ ?></td>
                            ...
                            <?php endforeach; ?>
                            <?php foreach($this->model->RentGraf2($Seg->TxtCodEmp, $Seg->TxtFIni, $Seg->TxtFFin) as $r): ?>
