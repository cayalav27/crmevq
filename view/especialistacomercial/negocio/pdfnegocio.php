<?php
    ...
    foreach($this->model->ListPipCal($pdfvnt->CodVnt, $iduser = $objses->get('CodEmp') , $iduser = $objses->get('CodPrf')) as $r):
                    ...
                    <tr>
                        ...
                        <td>';                    
                            ...
                            elseif($r->CodAvn =='3') {
                                ...
                                $content .= '<span>Cierre / Orden Compra</span>';
                                    }
    $content .= '
                        </td>
                    </tr>';
    ...
    foreach($this->model->ListDetTot($r->CodVnt) as $fila):
        if($fila["EstDetTot"] == '1'){ 
    $content .= '                
                    <tr>
    ...
    $content .= '                
                    <tr>
                        ...
                        <td width="25">:</td>';
    $content .= '
                        <td>'.number_format($fila["SbTDetTot"],2).'</td>';
    $content .= '
                    </tr>';        
        }
    endforeach;
