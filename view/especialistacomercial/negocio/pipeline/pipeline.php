                    ...
                    <div class="card">
                        <div class="header">
                            <ol class="breadcrumb breadcrumb-col-red">
                                ...
                                <li class="active"><i class="material-icons">assignment</i> Pipeline</li>
                            </ol>
                        </div>    
                        <div class="body table-responsive">
                            <table id="dtable" class="display compact" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    <?php $i = 1; ?>
                                    <?php foreach($this->model->ListPipCal($iduser = $objses->get('CodEmp') , $iduser = $objses->get('CodPrf')) as $r): ?>
                                    <tr>
                                        <td><?php echo $i++ ?></td>
                                        <td>
                                ...
                                <div class="modal fade" data-controls-modal="your_div_id" data-backdrop="static" data-keyboard="false" id="verpip-<?php echo $r->CodVnt; ?>" role="dialog">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form id="validate2" enctype="multipart/form-data">
