                    ...
                    <div class="card">
                        <div class="header">
                            <ol class="breadcrumb breadcrumb-col-red">
                                <li><a href="cliente"><i class="material-icons">account_balance</i> Clientes</a></li>
                            </ol>
                        </div>
                            ...
                            <div class="modal fade" data-controls-modal="your_div_id" data-backdrop="static" data-keyboard="false" id="nuevocli" role="dialog">
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form id="sign_in" action="<?php echo urlencode('cliente&a=RegCli'); ?>" method="post" enctype="multipart/form-data">
