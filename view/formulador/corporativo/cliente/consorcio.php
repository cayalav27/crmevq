                            ...
                            <ol class="breadcrumb breadcrumb-col-red">
                                <li>
                                    <span data-toggle='tooltip' data-placement="bottom" title='Volver'>
                                        <a href="clienteformulador"><i class="material-icons">account_balance</i> Clientes</a>
                                    </span>
                                </li>
                            ...
                            <div class="modal fade" data-controls-modal="your_div_id" data-backdrop="static" data-keyboard="false" id="editcli-<?php echo $cont->CodCli; ?>" role="dialog">
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form id="validate3" action="<?php echo urlencode('clienteformulador&a=UpdCli'); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <ul class="nav nav-tabs tab-col-teal" role="tablist">
                                    <li role="presentation">
                                        <a href="<?php echo urlencode('contactoformulador&a=Index&CodCli=').$cont->CodCli; ?>">CONTACTOS</a>
                                    </li>
                                    <li role="presentation" class="active">
                                        <a href="<?php echo urlencode('consorcioformulador&a=Index&CodCli=').$cont->CodCli; ?>">EMPRESAS</a>
                                    </li>
                                </ul>
                                       ...
                                       <table id="dtable" class="display compact" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class='btn-DltCnsForm' data-id="<?php echo $r['CodCli'] ?>" data-codcli="<?php echo $cont->CodCli; ?>" data-toggle='tooltip' data-placement="bottom" title='X - Eliminar' style="color:#cc0000">
                                                            <?php echo $r["NomCli"] ?>
                                                        </a>
                                                    </td>
                            ...
                            <div class="modal fade" data-controls-modal="your_div_id" data-backdrop="static" data-keyboard="false" id="nuevaempresa" role="dialog">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form id="validate1" action="<?php echo urlencode('consorcioformulador&a=UpdCliCns'); ?>" method="post" enctype="multipart/form-data">
                                            <div class="modal-body">
                                                <div class="row clearfix">
