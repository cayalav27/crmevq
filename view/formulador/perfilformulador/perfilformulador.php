                ...
                <div class="card">
                    ...
                    <div class="body table-responsive">
                        <div class="col-sm-4 col-md-4" align="center">
                            ...
                            <form id="sign_in" action="perfilformulador&a=UpdFotEmp" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-8 col-md-8">
                            <table class="table" style="border-left: 1px solid #D0D3D4">
                                <tbody>
                                    ...
                                    <tr>
                                        <td width="25"></td>
                                        <form id="sign_in" action="perfilformulador&a=UpdSrcEmp" method="post" enctype="multipart/form-data">
                                            <input type="hidden" name="TxtCodEmp" value="<?php echo $user = $objses->get('CodEmp'); ?>" />
                                        <th width="50"><h6>Score</h6></th>
                                        <td width="50"><h6>:</h6></td>
                                        <td width="200">
                                            <b>
                                                <div class="input-group form-float form-group-sm">
                                                    <select  name="TxtCodSrc" class="js-example-responsive form-control pmd-select2" style="width: 50%" required>
                                                        <?php foreach($this->model->ObtSrc() as $row): ?>
                                                            <option value="<?php echo $row->CodSrc; ?>" <?php if($objses->get('NumSrc')==$row->NumSrc) echo "selected"; ?> >
                                        ...
                                        <td width="50" align="right">
                                            <span data-toggle='tooltip' data-placement="left" title='Actualizar Score'>
                                    ...
                                    <tr>
                                        <td width="25"></td>
                                        <form id="sign_in" action="perfilformulador&a=UpdEmlEmp" method="post" enctype="multipart/form-data">
                                            <input type="hidden" name="TxtCodEmp" value="<?php echo $user = $objses->get('CodEmp'); ?>" />
                                    ...
                                    <tr>
                                        <td width="25"></td>
                                        <form id="sign_in" action="perfilformulador&a=UpdPswEmp" method="post" enctype="multipart/form-data">
                                            <input type="hidden" name="TxtCodEmp" value="<?php echo $user = $objses->get('CodEmp'); ?>" />
