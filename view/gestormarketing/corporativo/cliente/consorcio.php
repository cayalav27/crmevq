                                       ...
                                       <table id="dtable" class="display compact" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class='btn-DltCnsMkt' data-id="<?php echo $r['CodCli'] ?>" data-codcli="<?php echo $cont->CodCli; ?>" data-toggle='tooltip' data-placement="bottom" title='X - Eliminar' style="color:#cc0000">
                                                            <?php echo $r["NomCli"] ?>
                                                        </a>
                                                    </td>
                            ...
                            <div class="modal fade" data-controls-modal="your_div_id" data-backdrop="static" data-keyboard="false" id="nuevaempresa" role="dialog">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form id="validate1" action="<?php echo urlencode('consorciomkt&a=UpdCliCns'); ?>" method="post" enctype="multipart/form-data">
                                            <div class="modal-body">
                                                <div class="row clearfix">
